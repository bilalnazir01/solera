  ...
  return (
    ...
    >
      ...
      <div className="z-10 w-full max-w-[1180px] mx-auto grid lg:grid-cols-3 text-white pt-[156px] pb-[172px] lg:pb-[365px]">
        ...
        {/* First Part */}
        <div className="flex flex-col justify-center items-start z-50 mx-[26px] md:mx-[12px]">
        ...
        {/* Third Part */}
        <div className="flex flex-col justify-center items-end z-20 mx-[26px] md:mx-[12px]">
